...
/**
 * Class for an aluminum goal.
 * 
 * @author Andreas Wenger
 */
public class AluminumGoal
  implements Goal
{
   ...
   */
  public AluminumGoal(Vector3f position, float yRotation)
  {
    ...
    PhysicsManager physicsManager)
  {
    ...
    walls[0] = new Wall(null, bouncePost, PhysicsObject.TYPE_ALUMINUMGOALPOST);
    ...
    rects[1] = new Rectangle(new Vector3f[] {
      ...
      new Vector3f(-2, 1.9f, 0)});
    walls[1] = new Wall(null, bouncePost, PhysicsObject.TYPE_ALUMINUMGOALPOST);
    ...
    rects[2] = new Rectangle(new Vector3f[] {
      ...
      new Vector3f(2, 2, 0),
      new Vector3f(2, 0, 0)});
    walls[2] = new Wall(null, bouncePost, PhysicsObject.TYPE_ALUMINUMGOALPOST);
    ...
    String path = "data/meshes/aluminumgoal.x";
