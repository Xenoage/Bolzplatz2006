...
/**
 * Class that stores a outfield player mesh and information
 * about it (for example the meaning of its keyframes).
 *
 * @author   Andreas Wenger
 */
public class OutfieldPlayerMesh
  implements CharacterMesh
{
  ...
  public OutfieldPlayerMesh()
  {
    ...
    keyframes[as.ShootRunLeft.getID()][0] = 63;
    keyframes[as.ShootRunLeft.getID()][1] = 69;
    speedFactor[as.ShootRunLeft.getID()] = 1f;
    keyframes[as.ShootRunRight.getID()][0] = 49;
    keyframes[as.ShootRunRight.getID()][1] = 54;
    speedFactor[as.ShootRunRight.getID()] = 1f;
    ...
    keyframes[as.Tackle.getID()][0] = 70;
    keyframes[as.Tackle.getID()][1] = 115;
    speedFactor[as.Tackle.getID()] = 2f;
  ...
  public void loadMesh(String filename)
  {
    ...
    if (meshPlayer == null)
    {
      GameEngine.fatalError(this, new Exception("Outfield player mesh \"" +
