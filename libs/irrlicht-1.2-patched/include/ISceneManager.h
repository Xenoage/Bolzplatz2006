...
namespace scene
{
	...
	*/
	...
	public:
        ...
        //! BP2K6 (forgotten in Irrlicht 1.2): Sets ambient color of the scene
		virtual void setAmbientLight(video::SColorf ambientColor) = 0;

		//! BP2K6 (forgotten in Irrlicht 1.2): Returns ambient color of the scene
