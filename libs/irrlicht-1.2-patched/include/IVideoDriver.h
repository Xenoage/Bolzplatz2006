	...
	*/
	...
	public:
		...
		*/
		...
		\param colors: BP2K6: one color for each vertex
            (OLD: array of 4 colors denoting the color values of the corners of the destRect)
		...
		virtual void draw2DImage(video::ITexture* texture, const core::rect<s32>& destRect,
			const core::rect<s32>& sourceRect, const core::rect<s32>* clipRect = 0,
			/* BP2K6: */ SColor color=SColor(255,255,255,255) /* video::SColor* colors=0 */,
        ...
        \param color: color denoting the color values of the corners of the destRect
        \param useAlphaChannelOfTexture: true if alpha channel will be blended. */
        virtual void draw2DImageRotation(video::ITexture* texture, const core::rect<s32>& destRect,
            const core::rect<s32>& sourceRect, const f32 rotation = 0.0f,
            SColor color=SColor(255,255,255,255), bool useAlphaChannelOfTexture=false) = 0;
		...
		\param destRect: the rectangle to draw into
		\param sourceRect: the rectangle denoting a part of the texture
        \param rotationPos: the rotation point
		\param rotation: the clockwise rotation in radians
		\param color: (ANDI!) color denoting the color values of the corners of the destRect
		\param useAlphaChannelOfTexture: true if alpha channel will be blended. */
		virtual void draw2DImageRotation(video::ITexture* texture, const core::rect<s32>& destRect,
			const core::rect<s32>& sourceRect, const core::position2d<s32>& rotationPos,
            const f32 rotation, SColor color=SColor(255,255,255,255),
			bool useAlphaChannelOfTexture=false) = 0;
	};
