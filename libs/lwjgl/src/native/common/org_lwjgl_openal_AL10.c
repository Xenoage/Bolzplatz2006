...
alBufferDataPROC alBufferData;
alIsBufferPROC alIsBuffer;
alDeleteBuffersPROC alDeleteBuffers;
alGenBuffersPROC alGenBuffers;
...
alGetEnumValuePROC alGetEnumValue;
