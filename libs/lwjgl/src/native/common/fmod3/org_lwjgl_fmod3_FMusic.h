...
#include <jni.h>
/* Header for class org_lwjgl_fmod3_FMusic */

#ifndef _Included_org_lwjgl_fmod3_FMusic
#define _Included_org_lwjgl_fmod3_FMusic
#ifdef __cplusplus
extern "C" {
#endif
#undef org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_NONE
#define org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_NONE 0L
#undef org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_MOD
#define org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_MOD 1L
#undef org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_S3M
#define org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_S3M 2L
#undef org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_XM
#define org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_XM 3L
#undef org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_IT
#define org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_IT 4L
#undef org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_MIDI
#define org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_MIDI 5L
#undef org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_FSB
#define org_lwjgl_fmod3_FMusic_FMUSIC_TYPE_FSB 6L
/*
 * Class:     org_lwjgl_fmod3_FMusic
 * Method:    nFMUSIC_LoadSong
 * Signature: (Ljava/lang/String;)J
 */
JNIEXPORT jlong JNICALL Java_org_lwjgl_fmod3_FMusic_nFMUSIC_1LoadSong
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_org_lwjgl_fmod3_FMusic_nFMUSIC_1SetZxxCallback
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: (JI)Z
 */
JNIEXPORT jboolean JNICALL Java_org_lwjgl_fmod3_FMusic_nFMUSIC_1SetRowCallback
 ...
 * Signature: (JI)Z
 */
JNIEXPORT jboolean JNICALL Java_org_lwjgl_fmod3_FMusic_nFMUSIC_1SetOrderCallback
  (JNIEnv *, jclass, jlong, jint);
 ...
 * Signature: (JI)Z
 */
JNIEXPORT jboolean JNICALL Java_org_lwjgl_fmod3_FMusic_nFMUSIC_1SetInstCallback
  (JNIEnv *, jclass, jlong, jint);
 ...
 */
JNIEXPORT jboolean JNICALL Java_org_lwjgl_fmod3_FMusic_nFMUSIC_1SetUserData
 ...
 */
JNIEXPORT jobject JNICALL Java_org_lwjgl_fmod3_FMusic_nFMUSIC_1GetUserData
  (JNIEnv *, jclass, jlong, jint);
