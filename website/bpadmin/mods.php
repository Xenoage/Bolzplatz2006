...
// ACHTUNG: sollten neue Rubriken dazu kommen, muss es hier (Ordnername) ergaenzt werden:
// (da Feldinhalte/DB _leider_ nicht den gleichen Namen haben wie Downloadordner)
if ($_POST[type] == "team") {$MyDir = "teams";}
if ($_POST[type] == "stadium") {$MyDir = "stadiums";}
...
if ($donow == "new")                 # Neuer Eintrag? => Speichern
   ...
   if ($fatal == 0)                                       # ..und DB Eintrag
       {
       $file_name = $NewFile[0];
       $AddNow = "INSERT INTO mods (type, name, author, date, file )
                       VALUES (
                              '$_POST[type]',
                              '$_POST[name]',
                              '$_POST[author]',
       ...
       ?>
       <P><BR><a href="mods.php"><b>[weitere Mods eintragen]</b></a>
       <?
       }
       else {
...
<TR>
<TD><b>Type:</b></TD>
<TD><INPUT TYPE="radio" NAME="type" VALUE="team" checked>- Team
&nbsp;&nbsp;&nbsp;<INPUT TYPE="radio" NAME="type" VALUE="stadium">- Stadion</TD>
</TR>
<TR>
<TD><b>Name:</b></TD>
